...
@Component({
  selector: 'app-focused-note',
  templateUrl: './focused-note.component.html',
  styleUrls: ['./focused-note.component.scss']
})
export class FocusedNoteComponent implements OnInit {
